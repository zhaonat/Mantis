...
[Functions]
  ...
  [./ic_func2]
    ...
    direction = 'left'
    x = '0 33 66' # denotes position along horizontal axis where the interfaces will be
    y = '1 0 -1' #denotes magnitude of the variable at each of the partitions
  [../]
