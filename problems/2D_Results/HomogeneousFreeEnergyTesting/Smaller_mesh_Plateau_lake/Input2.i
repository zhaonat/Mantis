...
[Functions]
  ...
  [./ic_func2]
    ...
    direction = 'left'
    x = '0 5 10' # denotes position along horizontal axis where the interfaces will be
    y = '-2.35514 2.35514 -2.35514' #denotes magnitude of the variable at each of the partitions
  [../]

  #Piecewise Bilinear attempt 1
  [./ic_func_3]
    type = PiecewiseBilinear
    data_file = 'Dual_stripe_small.csv'
...
[Materials]
  ...
  [./free_energy]
    ...
    function = W*(1-c)^2*(1+c)^2*(c)^2+2.1-c^4
    enable_jit = true
    outputs = exodus
  [../]
[]
...
[Outputs]
  file_base = 'Plateau_potential_AT_minima_IC'
  output_initial = true
  exodus = true
