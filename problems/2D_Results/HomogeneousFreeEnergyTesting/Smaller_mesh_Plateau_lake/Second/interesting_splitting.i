...
[Functions]
  ...
  [./ic_func2]
    ...
    direction = 'left'
    x = '0 25 75' # denotes position along horizontal axis where the interfaces will be
    y = '-0.5 0.5 -0.5' #denotes magnitude of the variable at each of the partitions
  [../]
...
[Outputs]
  file_base = 'Plateau_potential_near_minima_IC'
  output_initial = true
  exodus = true
