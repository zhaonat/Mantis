...
[Materials]
  [./mat]
    type = PFMobility
    block = 0
    mob = 3 #mobility is flexibile, jsut keep constant throughout all tests
    kappa = 0.25 
...
[Outputs]
  file_base = out_width_11
  interval = 15 #interval only outputs the results after every n (in this case 15) timesteps
  output_initial = true
  exodus = true
