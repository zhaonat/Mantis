...
[Functions]
  ...
  [./ic_func2]
    ...
    y = '-1 1 -1 1.5 -1' #denotes magnitude of the variable at each of the partitions
  [../]
...
[Outputs]
  file_base = '1_layer_overpressurized'#new_title since the original file was overwritten
