...
[Kernels]
  ...
  [./c_res]
    type = SplitCHParsed
    variable = c
    f_name = fbulk #where free energy functional gets encoded?
    kappa_name = kappa_c
    w = w
  [../]
  [./w_res]
...
[Materials]
  ...
  [./mat]
    type = PFMobility
    block = 0
    mob = 1 #mobility is flexibile, jsut keep constant throughout all tests...actually if you increase it, you have to decrease time step so no use in killing this parameter
    kappa = .25
...
[Outputs]
  file_base = 'BarrierFuncMaterial_landau'
