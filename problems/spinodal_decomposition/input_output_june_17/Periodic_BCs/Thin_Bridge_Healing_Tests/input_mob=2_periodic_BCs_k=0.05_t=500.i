...
[Materials]
  [./mat]
    ...
    mob = 1
    kappa = 0.05
    #kappa is the coefficient of (del(c))^2, the penalty term of the cahn_hilliard, or the gradient coefficient
  [../]
  [./free_energy]
...
[Outputs]
  file_base = 'ThinBridge_t=500_periodic_mob=1_kappa = 0.05_bridgewidth=1'
  output_initial = true
  exodus = true
