...
#ifndef LAYERSINGLEDEFECTIC_H
#define LAYERSINGLEDEFECTIC_H
...
class LayerSingleDefectIC;
namespace libMesh { class Point; }

template<>
InputParameters validParams<LayerSingleDefectIC>();
 ...
 */
class LayerSingleDefectIC : public InitialCondition
{
public:
   ...
   */
  LayerSingleDefectIC(const InputParameters & parameters);
